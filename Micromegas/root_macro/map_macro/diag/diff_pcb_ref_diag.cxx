...
//p=1,2 -> int,ext
//q=1,2 -> tab,stif
void diff_pcb_ref_diag (int p,int q, string scan1, string scan2){
...
// reference files
   ...
   if(p==1){
     ...
     if(q==2){
      file3 << inpath2<< "mean_and_rep_diag_laser_int_sx_ref_S_n.root";    
      file4 << inpath2<< "mean_and_rep_diag_laser_int_dx_ref_S_n.root";
     }
   }
   else if (p==2){
     if(q==1){
     ...
     if(q==2){
      file3 << inpath2<< "mean_and_rep_diag_laser_ext_sx_ref_S_n.root";    
      file4 << inpath2<< "mean_and_rep_diag_laser_ext_dx_ref_S_n.root";
     }
   }
...
// leggo file e riempio array con coord
 ...
 // create a root file for the histograms;
  ...
  rootfile  << outpath <<"/diff_pcb_plate_diag_" << scan1 << "_" << scan2 << ".root";   //*************!!!!!!
  ...
  txtfile << outpath <<"/summary_diff_pcb_plate_diag_" << scan1 << ".txt"; 
  ...
  mapcorr1 << outpath << "/diff_pcb_plate_diag_mapSX_" << scan1 << "_" << scan2 <<".png";

  ostringstream mapcorr2;
  mapcorr2 << outpath << "/diff_pcb_plate_diag_mapDX_" << scan1 << "_" << scan2 << ".png";

  ostringstream zcorr;
  zcorr << outpath << "/diff_pcb_plate_diag_zdistrib_" << scan1 << "_" << scan2 << ".png";
...
//   map_s1->GetZaxis()->SetRangeUser(0.500, 0.800);
   map_s1->Write();
  ...
  // map_s2->GetZaxis()->SetRangeUser(0.500, 0.800);
   map_s2->Write();
   ...
   //ref_s1->GetZaxis()->SetRangeUser(0.500, 0.800);
   ref_s1->Write();
   ...
   //ref_s2->GetZaxis()->SetRangeUser(0.500, 0.800);
   ref_s2->Write();
   ...
   diff1->GetZaxis()->SetRangeUser(0.500, 0.800);
   diff1->Write();
   ...
   diff2->GetZaxis()->SetRangeUser(0.500, 0.800);
   diff2->Write();
