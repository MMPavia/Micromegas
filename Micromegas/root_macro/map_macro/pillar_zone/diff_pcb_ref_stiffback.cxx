...
void diff_pcb_ref_stiffback (string scan){
...
// reference files
   ostringstream file2;
   file2 << inpath2 << "mean_and_rep_plates_laser_ref_stif_new.root"; 
...
// leggo file e riempio array con coord
 ...
 // create a root file for the histograms;
  ...
  Data << "Mean   rms   min   max" << "\n" << media << "\t" << stdev << "\t" << minimo << "\t" << massimo << endl;
   ...
   //diff->GetZaxis()->SetRangeUser(600, 800);
   //diff->GetZaxis()->SetRangeUser(400, 1000); //PCB
   diff->Write();
