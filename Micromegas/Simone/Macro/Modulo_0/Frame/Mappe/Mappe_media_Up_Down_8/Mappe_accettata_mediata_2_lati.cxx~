...
void Mappe_8_201_208 (string scan1, string scan2 ,string scan3,string scan4,string scan5, string scan6, string scan7,string scan8,string scan9,string scan10,
...
//  2d map of the table surface
   TH2F *tmap1= new TH2F("Frame 209","Frame number 201", nxbin, xmin, xmax, nybin, ymin, ymax );
