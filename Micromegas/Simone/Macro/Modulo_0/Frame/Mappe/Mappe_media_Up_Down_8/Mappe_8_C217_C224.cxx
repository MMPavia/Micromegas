...
void Mappe_8_C217_C224 (string scan1, string scan2 ,string scan3,string scan4,string scan5, string scan6, string scan7,string scan8,string scan9,string scan10,
...
//   tmap1->SetTitleOffset(2);
   ...
   tmap1->GetZaxis()->SetRangeUser(-120,-60);
