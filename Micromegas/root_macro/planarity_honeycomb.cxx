...
void planarity_honeycomb (string scan){
  ...
  map_diff->GetZaxis()->SetTitle("Z (mm)");
  ...
  TH1F *z_corr = new TH1F("z_corr","z_corr",  30, 10, 10.3 ); // z= diff tra tastatore e ottico
