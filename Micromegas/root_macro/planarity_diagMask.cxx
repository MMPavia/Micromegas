...
void planarity_diagMask (string scan){
  ...
  TH1F *z_corr = new TH1F("z_corr","z_corr",  100, 11.2, 11.7 ); // z= diff tra tastatore e ottico
...
*/
  ...
  TLine *l1 = new TLine(440,-40,440,920);
  TLine *l2 = new TLine(840,-40,840,920);
  TLine *l3 = new TLine(1320,-40,1320,920);
  TLine *l4 = new TLine(1720,-40,1720,920);
