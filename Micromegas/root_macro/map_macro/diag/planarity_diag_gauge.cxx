...
//#define inpath "/Users/gabriella/cernbox/MM_Pavia/Data/Data2017/17_PannelloEtaMod05_2017_02_21/Data/"
//#define outpath "/Users/gabriella/cernbox/MM_Pavia/Data/Data2017/17_PannelloEtaMod05_2017_02_21/Plot/"



void planarity_diag_gauge (int p, string scan1, string scan2){
...
// reference files
   ...
   if(p==1){
      ...
      file3 << inpath<< "mean_and_rep_diag_gauge_int_sx.root";    
      file4 << inpath<< "mean_and_rep_diag_gauge_int_dx.root";
   }
   else if (p==2){

      file3 << inpath<< "mean_and_rep_diag_gauge_ext_sx.root";    
      file4 << inpath<< "mean_and_rep_diag_gauge_ext_dx.root";
...
// leggo file e riempio array con coord
 ...
 // create a root file for the histograms;
  ...
  zcorr << outpath << "/diff_pan_plate_diag_zdistrib_" << scan1 << "_" << scan2 << ".png";
   ...
   map_s1_p->SetMarkerSize(0.8);
   map_s1_p->Draw("colz1,text45");
   map_s1_p->SetStats(kFALSE);
   map_s1_p->Write();

   TCanvas *c1 = new TCanvas("map_dx","map_dx",1000,700);
   map_s2_p->SetMarkerSize(0.8);
   map_s2_p->Draw("colz1,text45");
   map_s2_p->SetStats(kFALSE);
   map_s2_p->Write();
