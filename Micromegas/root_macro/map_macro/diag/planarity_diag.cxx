...
void planarity_diag (int p, int q, string scan1, string scan2){
...
// reference files
   ...
   if(p==1){                                                      //p=1 interna
            if(q==1){
                      file3 << inpath<< "mean_and_rep_diag_gauge_int_sx.root";    //q=1 gauge
                      file4 << inpath<< "mean_and_rep_diag_gauge_int_dx.root";
            }
	    else if(q==2){
                      file3 << inpath<< "mean_and_rep_diag_laser_int_sx.root";    //q=2 laser
                      file4 << inpath<< "mean_and_rep_diag_laser_int_dx.root";
            ...
            if(q==1){
                      file3 << inpath<< "mean_and_rep_diag_gauge_ext_sx.root";    //q=1 gauge
                      file4 << inpath<< "mean_and_rep_diag_gauge_ext_dx.root";
            }
	    else if(q==2){
                      file3 << inpath<< "mean_and_rep_diag_laser_ext_sx.root";    //q=2 laser
                      file4 << inpath<< "mean_and_rep_diag_laser_ext_dx.root";
            }
