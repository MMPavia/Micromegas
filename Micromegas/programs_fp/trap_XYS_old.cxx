	...
	if (nmots < 2)
	   {
        ...
        fp_di_XXX* a = fp_di_XXX::create(5);

	cout << hex << " id: " << a->fp_moduleID() << dec << endl;
	cout << hex << " all ids: " << a->fp_allIDs() << dec << endl;
	cout << hex << " status: " << a->fp_status() << dec << endl;
	cout << hex << " range(2): " << a->fp_range( 2 ) << dec << endl;
	cout << hex << " discrete: " << a->fp_discrete() << dec << endl;
	cout << hex << " status(5): " << a->fp_status( 5 ) << dec << endl;
