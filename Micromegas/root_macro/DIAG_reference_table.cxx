...
void DIAG_reference_table (int p, string scan1, string scan2, string scan3){
...
/*
  ...
  */    
   ...
   TH1F *dz_distrib = new TH1F("dz_distrib","Repeatability Distribution", 30, -10, 20);
   // TH1F *dz_distrib = new TH1F("dz_distrib","Repeatability Distribution", 90, -9, 80);
   ...
   TH1F *std_distrib = new TH1F("std_distrib","std Distribution", 15, -5, 10);
   // TH1F *std_distrib = new TH1F("std_distrib","std Distribution", 50, -1, 40);
...
// leggo array e calcolo rep come dz
 ...
 // create a root file for the histograms;
  ...
  if(p==1){
    rootfile << outpath << "reference_table_diag_int_sx.root";
  }
  else if(p==2){
    rootfile << outpath << "reference_table_diag_int_dx.root";
  }
  else if(p==3){
    rootfile << outpath << "reference_table_diag_ext_sx.root";
  }
  else if(p==4){
    rootfile << outpath << "reference_table_diag_ext_dx.root";
  }
