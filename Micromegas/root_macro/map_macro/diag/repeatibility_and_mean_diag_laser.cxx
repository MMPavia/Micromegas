...
void repeatibility_and_mean_diag_laser (int p, string scan1, string scan2, string scan3, string scan4, string scan5){
//void repeatibility_and_mean_diag_laser (int p, string scan1, string scan2, string scan3){
...
// file containing the data
   ...
   distz_s3->SetFillColor(2);
    ...
    TH1F *distz_s4 = new TH1F("distz_s4","distz_s4",  ndistbin,xdistmin, xdistmax  ); 
    distz_s4->GetXaxis()->SetTitle("#mu ");
    distz_s4->GetYaxis()->SetTitle("counts");
    distz_s4->SetFillColor(2);

    TH1F *distz_s5 = new TH1F("distz_s5","distz_s5",  ndistbin,xdistmin, xdistmax ); 
    distz_s5->GetXaxis()->SetTitle("#mu ");
    distz_s5->GetYaxis()->SetTitle("counts");
    distz_s5->SetFillColor(2);   
   ...
   TH1F *dz_distrib = new TH1F("dz_distrib","Repeatability Distribution", 50, -9, 60);
   ...
   TH1F *std_distrib = new TH1F("std_distrib","std Distribution", 30, -5, 80);
   std_distrib->GetXaxis()->SetTitle("Z (#mum)");
   std_distrib->SetFillColor(4);


   Float_t dd1, dd2, dd3, dd4, dd5, mean, laser0; 
   //Float_t dd1, dd2, dd3, mean, laser0; 
...
// leggo array e calcolo rep come dz
 ...
 // create a root file for the histograms;
  ...
  rootfile  << outpath <<"mean_and_rep_diag_laser.root";   //*************!!!!!!
